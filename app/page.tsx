...
export default function MissionLineWebsite() {
  ...
  const handleQuoteSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const mailSubject = encodeURIComponent(
      subject.trim() || "Quote Request - MissionLine"
    );
...
${message}`
    ...
    window.location.href = `mailto:info@missionlineusa.com?subject=${mailSubject}&body=${mailBody}`;
  };
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      <header className="sticky top-0 z-20 border-b border-white/10 bg-slate-950/80 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <a
            href="mailto:info@missionlineusa.com?subject=Quote Request - MissionLine"
          ...
          <div className="relative mx-auto grid max-w-7xl gap-10 px-6 py-24 md:grid-cols-2 md:items-center">
            <div>
              ...
              <p className="mt-6 max-w-xl text-lg leading-8 text-slate-200">
                MissionLine delivers dependable logistics services and
                construction support with a commitment to professionalism,
                responsiveness, and quality execution.
              </p>
            ...
            <div className="grid gap-4">
              <div className="rounded-3xl border border-white/10 bg-white/10 p-8 shadow-sm backdrop-blur ring-1 ring-white/10">
                ...
                <p className="mt-4 text-lg leading-8 text-slate-100">
                  To provide efficient, trustworthy, and mission-driven
                  logistics and construction services that help clients complete
        ...
        <section id="about" className="border-y border-slate-200 bg-white">
          <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 md:grid-cols-2">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-600">
              <p>
                MissionLine is a Virginia-based business offering logistics
                services and construction support for clients who value
                dependable execution and clear communication.
              </p>
              <p>
                We are committed to delivering practical solutions, staying
                responsive to client needs, and supporting projects with
          ...
          <div className="mx-auto grid max-w-7xl gap-10 px-6 pb-20 md:grid-cols-2">
            <div className="rounded-3xl bg-slate-50 p-8 ring-1 ring-slate-200">
              ...
              <p className="mt-4 text-lg leading-8 text-slate-700">
                To deliver responsive, high-quality logistics, construction, and
                operational support services that meet the needs of government
                and commercial clients with precision, accountability, and
                excellence.
              </p>
            </div>
            ...
            <div className="rounded-3xl bg-slate-50 p-8 ring-1 ring-slate-200">
              ...
              <p className="mt-4 text-lg leading-8 text-slate-700">
                To grow into a trusted contracting partner known for reliable
                performance, strong values, and exceptional service across every
                mission we support.
              </p>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-6 py-20">
            <div className="max-w-3xl">
              ...
              <p className="mt-6 text-lg leading-8 text-slate-600">
                MissionLine provides flexible support services designed to help
                clients execute projects efficiently and professionally. This
                section can also be used as the foundation for a future
          ...
          <div className="mx-auto max-w-7xl px-6 py-20">
            <div className="max-w-3xl">
              ...
              <p className="mt-6 text-lg leading-8 text-slate-300">
                MissionLine is building a strong foundation to pursue government
                and commercial opportunities through dependable service,
                organized operations, and client-focused execution.
              </p>
            </div>
        ...
        <section id="projects" className="bg-slate-900 text-white">
          <div className="mx-auto max-w-7xl px-6 py-20">
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">
              This section can later feature completed projects, capabilities,
              certifications, or past performance details to help build
              credibility with future clients.
            </p>
          ...
          <div className="grid gap-10 md:grid-cols-2">
            ...
            <div className="rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-200">
              <form onSubmit={handleQuoteSubmit} className="grid gap-4">
                ...
                <textarea
                  name="message"
                  className="min-h-[140px] rounded-2xl border border-slate-300 px-4 py-3 outline-none"
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="mx-auto flex max-w-7xl flex-col gap-3 px-6 py-8 text-sm text-slate-500 md:flex-row md:items-center md:justify-between">
          <p>
            © 2026 MissionLine Logistics Services & Construction. All rights
            reserved.
          </p>
